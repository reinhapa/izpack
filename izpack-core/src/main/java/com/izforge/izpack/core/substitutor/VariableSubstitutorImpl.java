...
public class VariableSubstitutorImpl implements VariableSubstitutor
{
    ...
    public void substitute(InputStream in, OutputStream out, SubstitutionType type, String encoding)
            throws IOException
    {
        IOUtils.copy(new VariableSubstitutorInputStream(in, encoding, variables, type, bracesRequired), out);
    }
    ...
    {
        IOUtils.copy(new VariableSubstitutorReader(reader, variables, type, bracesRequired), writer);
    }
